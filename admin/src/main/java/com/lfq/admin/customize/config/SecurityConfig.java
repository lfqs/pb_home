...
//            }
            ServletHolderUtil.renderString(response, JSONUtil.toJsonStr(ResponseVO.ok()));
        };
    }
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .and()
                // 禁用 X-Frame-Options 响应头。解释：X-Frame-Options 是一个 HTTP 响应头，用于防止网页被嵌入到其他网页的 <frame>、<iframe> 或 <object> 标签中，从而可以减少点击劫持攻击的风险
