package com.lfq.service.system.user.dto;


import cn.hutool.core.bean.BeanUtil;
import com.lfq.common.annotation.ExcelColumn;
import com.lfq.common.annotation.ExcelSheet;
...
import com.lfq.service.system.user.entity.SearchUser;
...
public class UserDTO {
    ...
    public UserDTO(SearchUser entity) {
        if (entity != null) {
            BeanUtil.copyProperties(entity, this);
